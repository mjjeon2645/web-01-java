...
class AccountTest {
  ...
  void processOneTransaction() {
    Transaction transaction = new Transaction("잔액", 2000);
    TransactionResult transactionResult = new TransactionResult(transaction, 2000);
    Account account = new Account();
  ...
  void processTransactions() {
    ...
    List<TransactionResult> transactionResult = List.of(
        ...
        new TransactionResult(transactions.get(2), 2000)
    );
